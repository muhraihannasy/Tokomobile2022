    ...
    <footer className=" mt-[3rem] bg-slate-200 pt-10">
      <div className="container grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-10">
        <div className="text-center md:text-left mb-[2rem]">
                ...
                <p className="text-[14px]"> Platform e-commerce UMKM yang membantu para penjual online untuk dapat melakukan kegiatan berdagang online lebih mudah, hemat waktu dan efesien</p>
        </div>
            <div className="text-center md:text-left mb-[2rem]">
                <h2 className="text-primary font-bold text-[1.2rem] mb-[1rem]">
                    Halaman
                ...
                <ul className="text-primary text-[14px]">
                    ...
                    <li><Link to="">Fitur Tokomobile</Link></li>
                    <li><Link to="">Harga Paket</Link></li>
                    <li><Link to="/syarat_ketentuan">Syarat dan ketentuan</Link></li>
                    <li><Link to="/kebijakan_privasi">Kebijakan privasi</Link></li>
                </ul>
            </div>
            <div className="text-center md:text-left mb-[2rem]">
                <h2 className="text-primary font-bold text-[1.2rem] mb-[1rem]">
            ...
            <div className="mb-[2rem]">
                ...
                <div className="mb-[0.5rem]">
                    ...
                    <p className="text-[14px]">Ruko Rose Garden 1 No 30, Grand Galaxy City, Bekasi Jawa Barat 17147</p>
                </div>
                <div>
                    <h3 className="font-bold text-[#666666]">Yogyakarta</h3>
                    <p className="text-[14px]">Ring Road Selatan No 64, Plumbon, Banguntapan, Bantun, Yogyakarta</p>
                </div>
            </div>
